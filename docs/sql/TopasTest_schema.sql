-- Схема базы данных TopasTest (тестовая БД для тестов хранилища).
-- Выполнять при подключении к базе TopasTest:
--   psql -U postgres -h localhost -p 5433 -d TopasTest -f TopasTest_schema.sql
